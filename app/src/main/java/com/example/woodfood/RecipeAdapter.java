...
public class RecipeAdapter extends RecyclerView.Adapter<RecipeAdapter.ViewHolder> implements Filterable {
    ...
    RecipeAdapter(Context context, ArrayList<Recipe> recipesData) {
        ...
        public RecipeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.list_recipes, parent, false));
        }
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            void bindTo(Recipe currentRecipe){
                ...
                itemView.findViewById(R.id.save_recipe).setOnClickListener(view ->{
                            Animation animation = AnimationUtils.loadAnimation(mContext, R.anim.blink_anim);
                            view.startAnimation(animation);
                            ((RecipeListActivity)mContext).updateAlertIcon(currentRecipe);
                });
                ...
                itemView.findViewById(R.id.delete).setOnClickListener(view ->{
                            ((RecipeListActivity)mContext).deleteItem(currentRecipe);
                            Animation animation = AnimationUtils.loadAnimation(mContext, R.anim.blink_anim);
                            view.startAnimation(animation);
                });
            }
